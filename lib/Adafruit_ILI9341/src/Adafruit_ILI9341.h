...
#define ILI9341_TREFOFF 0x34
#define ILI9341_TREFON  0x35
#define ILI9341_MADCTL  0x36
#define ILI9341_PIXFMT  0x3A
#define ILI9341_RAMWRCT 0x3C
...
class Adafruit_ILI9341 : public Adafruit_GFX {
 ...
 public:
  ...
  void     begin(void),
           ...
           startWrite(),
           contWrite(),
           fillRedScreen(uint16_t color),
           fillRedRect(int16_t x, int16_t y, int16_t w, int16_t h,
             uint16_t color),
           dmaspiwrite(uint8_t* c, uint16_t length, void (*dmaCB)());
