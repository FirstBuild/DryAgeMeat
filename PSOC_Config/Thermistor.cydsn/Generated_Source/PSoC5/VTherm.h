...
*/
     ...
     *  @{
     */
        #define VTherm_INTR_NONE      (uint16)(0x0000u)
        #define VTherm_INTR_RISING    (uint16)(0x0001u)
        #define VTherm_INTR_FALLING   (uint16)(0x0002u)
        #define VTherm_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */
