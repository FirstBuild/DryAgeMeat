...
#if !(CY_PSOC5A &&\
	 V_hi__PORT == 15 && ((V_hi__MASK & 0xC0) != 0))
...
*/
     ...
     *  @{
     */
        #define V_hi_DM_ALG_HIZ         PIN_DM_ALG_HIZ
        #define V_hi_DM_DIG_HIZ         PIN_DM_DIG_HIZ
        #define V_hi_DM_RES_UP          PIN_DM_RES_UP
        #define V_hi_DM_RES_DWN         PIN_DM_RES_DWN
        #define V_hi_DM_OD_LO           PIN_DM_OD_LO
        #define V_hi_DM_OD_HI           PIN_DM_OD_HI
        #define V_hi_DM_STRONG          PIN_DM_STRONG
        #define V_hi_DM_RES_UPDWN       PIN_DM_RES_UPDWN
    /** @} driveMode */
/** @} group_constants */
...
*/
     ...
     *  @{
     */
        #define V_hi_INTR_NONE      (uint16)(0x0000u)
        #define V_hi_INTR_RISING    (uint16)(0x0001u)
        #define V_hi_INTR_FALLING   (uint16)(0x0002u)
        #define V_hi_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */
