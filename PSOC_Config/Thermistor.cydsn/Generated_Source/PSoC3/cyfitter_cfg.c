...
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x00080068u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x00080070u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_REG8((void CYXDATA *)CYREG_PRT3_AMUX, 0x80u);
	CY_SET_REG16((void CYXDATA *)CYREG_PRT5_AMUX, 0x0201u);
	CY_SET_REG8((void CYXDATA *)CYREG_SC3_SW0, 0x24u);
	CY_SET_REG16((void CYXDATA *)CYREG_OPAMP3_MX, 0x0109u);
	CY_SET_REG8((void CYXDATA *)CYREG_BUS_SW0, 0xA2u);
...
uint8 CYXDATA * const CYCODE AMux_CYAMUXSIDE_A__addrTable[4] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_CYAMUXSIDE_A__maskTable[4] = {
	0x80u, 0x80u, 
	0x02u, 0x00u, 
};
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE AMux_CYAMUXSIDE_B__addrTable[4] = {
	(uint8 CYXDATA *)CYREG_DSM0_SW4, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT5_AG, (uint8 CYXDATA *)CYREG_DSM0_SW4, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_CYAMUXSIDE_B__maskTable[4] = {
	0x02u, 0x00u, 
	0x04u, 0x20u, 
};
